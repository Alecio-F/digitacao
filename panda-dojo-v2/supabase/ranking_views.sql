...
-- Ranking Online por Fases - melhor resultado por usuario por fase (lesson_id).
--
-- Particao por (user_id, lesson_id) garante que cada usuario aparece no maximo
-- uma vez dentro de cada fase. Permite que o mesmo jogador figure em fases
-- distintas com seus melhores resultados individuais.
...
-- Ranking Online por Textos - melhor resultado por usuario por texto (practice_text_id).
--
-- Particao por (user_id, practice_text_id) garante que cada usuario aparece no maximo
-- uma vez dentro de cada texto. Permite que o mesmo jogador figure em textos
-- distintos com seus melhores resultados individuais.
